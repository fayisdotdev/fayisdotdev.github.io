...
(function () {
  ...
  function createRipple(e) {
    ...
    ripple.style.transition = 'transform 450ms cubic-bezier(.2,.8,.2,1), opacity 600ms linear';
  ...
  function initTheme() {
    ...
    btn.addEventListener('click', () => {
      ...
      btn.animate([{ transform: 'scale(1)' }, { transform: 'scale(0.92)' }, { transform: 'scale(1)' }], { duration: 220 });
    });
  }
